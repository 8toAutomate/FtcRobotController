...
@Autonomous(name="Right2WobbleTargets", group="Motion")
public class AutoRightV1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Backup to be behind the line, to start looking for it
        robot.GoDistanceCM(-15, .8, this);
        // Line up to the line
        robot.findLine(.5);
        // Backup a tiny bit that way we aren't on the line, but behind it
        robot.GoDistanceCM(-5, .8, this);
        // Have method(s) that shoot 3 rings here
